  ...
  return (
    <main>
      ...
      <section id="sobre">
        <h2>Sobre nós</h2>
        <p>
          Somos uma academia focada em perda de peso e construção de shapes
          incríveis, no estilo Mr. Olympia. Com 2 dias de experiência no
          mercado, esperamos oferecer o melhor para nossos clietes. Quer ser um
          BodyBuild? Nós podemos te ajudar!
        </p>
      </section>


    <section id="textinho"><h2>Nossas Modalidades</h2></section>
